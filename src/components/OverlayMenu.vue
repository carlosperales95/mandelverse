  ...
  <div class="flex flex-col fixed bottom-24 h-60 w-full z-50">
    ...
    >
      <div
        ...
        class="h-60 w-full flex justify-center p-2"
      >
        <div
          class="relative flex items-start justify-center md:w-1/2 w-full h-full"
        >
          <!-- Main Control Panel -->
          <div
            class="p-4 w-4/5 h-full bg-black/40 backdrop-blur-xl text-white border-emerald-300 border shadow-2xl rounded-2xl z-50 overflow-y-scroll"
          >
            <div class="grid grid-cols-5 gap-2">
              <div class="flex flex-col gap-2 col-span-3">
                ...
                <div class="flex gap-3">
                  ...
                  <BaseButton
                    v-tooltip="
                      isAutoZooming ? 'Pause auto-zoom' : 'Start auto-zoom'
                    "
                    class="w-14"
